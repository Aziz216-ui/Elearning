 ...
 */
final class Version20251113220128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auteur ADD cours_id INT DEFAULT NULL, DROP bio');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auteur ADD bio VARCHAR(255) DEFAULT NULL, DROP cours_id');
    }
}
