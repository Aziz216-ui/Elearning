...
final class Version20251203180055 extends AbstractMigration 
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($schema->hasTable('forul_comment') && $schema->hasTable('forum_post') && !$this->foreignKeyExists('forul_comment', 'FK_72C30B5E4B89032C')) {
            $this->addSql('ALTER TABLE forul_comment ADD CONSTRAINT FK_72C30B5E4B89032C FOREIGN KEY (post_id) REFERENCES forum_post (id)');
        }
        if ($schema->hasTable('forul_comment') && $schema->hasTable('user') && !$this->foreignKeyExists('forul_comment', 'FK_72C30B5EA76ED395')) {
            $this->addSql('ALTER TABLE forul_comment ADD CONSTRAINT FK_72C30B5EA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        }
        if ($schema->hasTable('forum_post') && $schema->hasTable('user') && !$this->foreignKeyExists('forum_post', 'FK_996BCC5AA76ED395')) {
            $this->addSql('ALTER TABLE forum_post ADD CONSTRAINT FK_996BCC5AA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        }
        if ($schema->hasTable('forum_post') && $schema->hasTable('category') && !$this->foreignKeyExists('forum_post', 'FK_996BCC5A12469DE2')) {
